...
export default function FriendTab() {
	...
	const GenerateFriendCard = (friendRequest, avatar, nickName, descriptXcaracters) => {
		return (
			<>
				<div className={styles.friendRequest__user__div}>
					{avatar && (
						<Avatar userInfo={friendRequest} size={'small'}/>
					)}
				...
				{Object.keys(friendRequest).map((request, index) => {
					...
					return (
						<div key={index} className={styles.divGrapping}>
							{GenerateFriendCard(friendRequest[request], avatar, nickName, descriptXcaracters)}
				...
				return (
					<div className={styles.searchFriend__result}>
						{searchFriendResult.users.map((friend, index) => {
							...
							return (
								<div key={index} className={styles.divGrapping}>
									{GenerateFriendCard(friend, avatar, nickName, descriptXcaracters)}
									<div className={styles.friendRequest__user__Icons}>
